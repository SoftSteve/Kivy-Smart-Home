...
class CustomBlindButton(MDCard):
    ...
    def __init__(self, store, **kwargs):
        ...
        self.dimmer = BlindsSwiper(parent=self)
    ...
    def initialize_dimmer_state(self):
        if self.switch_active:
            self.animate_dimmer(self.blinds_start)
        else:
    ...
    def toggle_active(self, instance):
        ...
        self.store.update_states(self.button_id, self.text, self.switch_active, self.blinds_start)
