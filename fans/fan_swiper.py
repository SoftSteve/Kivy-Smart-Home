...
class FanSwiper(FloatLayout):
    def __init__(self, parent, **kwargs):
        ...
        self.initial_swipe_position = self.parent_widget.fan_speed
        ...
        self.thumb = MDIconButton(
            ...
            size_hint=(None, None), 
            width = self.parent_widget.width * 0.05,
            height = self.parent_widget.height * 0.075,
            font_size = self.parent_widget.width * 0.02,
            ripple_effect = False
        )  
